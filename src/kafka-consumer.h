...
class KafkaConsumer : public Connection {
 ...
 public:
  ...
  std::map<RdKafka::TopicPartition*, QueueCallbacks::QueueEventCallbackOpaque *, QueueCallbacks::CompareTopicPartition> queue_dispatcher_opaques;
